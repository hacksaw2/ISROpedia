...
<div className="container flex justify-center bg-red-500 w-[100vw] mb-2 mt-2">
        ...
        <div className="table   w-[80vw] p-1 ">
          <div className="container grid-item bg-blue-400 rounded-xl h-12 p-3 text-center 
            text-2xl font-bold text-gray-700">Name</div>
          <div className="container2 grid-item bg-orange-400 h-12 rounded-xl p-3 text-center text-2xl font-bold text-gray-700">Place</div>
          <div className="container3 grid-item bg-pink-400 h-12 rounded-xl p-3 text-center text-2xl font-bold text-gray-700">State</div>
        </div>
        </div>
